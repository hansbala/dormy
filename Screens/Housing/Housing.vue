  ...
  <view class="container">
    ...
    <scroll-view class="scrollable-section">
      ...
      <view class="filter-wrapper">
        ...
        <touchable-opacity
          :on-press="toggleFilterBySaved"
          class="filter-toggler"
          :class="savedFilter.filterOn ? 'black-br' : 'red-br'"
        >
          <text :class="savedFilter.filterOn ? 'black-txt' : 'red-txt'" class="filter-type">Saved</text>
        </touchable-opacity>
      </view>
...
export default {
  ...
  computed: {
    filteredPosts() {
      return this.housingListings.filter((listing) => {
        ...
        // Checking for saved filter
        if (this.savedFilter.filterOn) {
          if (this.bookmarks.includes(listing.id)) {
            return true;
          } else {
            return false;
          }
  ...
  methods: {
    ...
    toggleFilterBySubLease() {
      this.rentalTypeFilter.filterOn = !this.rentalTypeFilter.filterOn;
      this.rentalTypeFilter.subLeaseFilterOn = !this.rentalTypeFilter
        .subLeaseFilterOn;
    },
    toggleFilterByApartment() {
      this.housingTypeFilter.filterOn = !this.housingTypeFilter.filterOn;
      this.housingTypeFilter.apartmentFilterOn = !this.housingTypeFilter
        .apartmentFilterOn;
    },
    toggleFilterByHouse() {
      this.housingTypeFilter.filterOn = !this.housingTypeFilter.filterOn;
      this.housingTypeFilter.houseFilterOn = !this.housingTypeFilter
        .houseFilterOn;
    },
    toggleFilterByRoom() {
      this.housingTypeFilter.filterOn = !this.housingTypeFilter.filterOn;
      this.housingTypeFilter.roomFilterOn = !this.housingTypeFilter
        .roomFilterOn;
    },
    toggleFilterBySaved() {
      this.housingTypeFilter.filterOn = !this.housingTypeFilter.filterOn;
      this.savedFilter.filterOn = !this.savedFilter.filterOn;
    },
    navDrawerOpen() {
