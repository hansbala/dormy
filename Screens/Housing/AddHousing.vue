        ...
        <nb-container v-else>
            ...
            <nb-content>
                ...
                <view class="section">
                    ...
                    <view class="image-picker">
                        ...
                        <view
                            ...
                            v-for="selected_img in imageSelectedUri" :key="selected_img">
                            <image
                                v-if="imagePicked"
                                class="image-preview"
                                :source="{uri: selected_img}" />
                        </view>
                    </view>
                </view>
                ...
                <view class="section horizontal-flex" :style="{alignItems: 'center'}">
                    ...
                    >
                        <nb-item v-for="type in housingTypes" 
                            :key="type" 
                            :label="type" 
                            :value="type"
                        />
                ...
                <view class="section horizontal-flex" :style="{alignItems: 'center'}">
                    ...
                    >
                        <nb-item v-for="type in rentalTypes" 
                            :key="type" 
                            :label="type" 
                            :value="type"
                        />
