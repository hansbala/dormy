...
<template>
  <view class="container">
    ...
    <view class="header-wrapper">
      <touchable-opacity :on-press="navDrawerOpen" class="menu-icon-wrapper">
      ...
      <view class="section-wrapper">
        ...
        <view class="section-header">
          <view class="section-descriptor">
            ...
            <text class="fnt-grey">Latest based on your location</text>
          </view>
          <touchable-opacity
            :on-press="() => this.props.navigation.navigate('HomeFeed')"
            class="arrow-icon-wrapper"
          >
            <image class="arrow-icon" :source="require('../../assets/iconsv2/right-arrow.png')" />
          </touchable-opacity>
        </view>

        <!-- Horizontall scroll view section -->
        <scroll-view :horizontal="true" class="scroll-section">
