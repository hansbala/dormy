      ...
      <nb-card>
        <nb-card-item bordered>
          ...
          >
            ...
            <touchable-opacity
              class="ride-btn"
              style="background-color: #FEC33A"
              :on-press="() => changeRideType('Taxi')"
            >
            ...
            <touchable-opacity
              ...
              :on-press="() => changeRideType('Carpool')"
            >
  ...
  computed: {
    filteredPosts() {
      return this.dataArray.filter((post) => {
        return (
          (post.username.match(this.searchString) ||
            post.location.pickup.match(this.searchString) ||
            post.location.dropoff.match(this.searchString)) &&
          post.rideType.match(this.rideType)
        );
      });
    },
  },
